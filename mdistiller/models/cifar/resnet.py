...
class ResNet_test(nn.Module):
    def __init__(self, depth, num_filters, block_name="BasicBlock", num_classes=10):
        ...
        self.conv_test = nn.Conv2d(num_filters[3] * block.expansion, num_classes, kernel_size=1, padding=0, bias=False)
        self.inplanes = num_filters[0]
        self.conv1 = nn.Conv2d(3, num_filters[0], kernel_size=3, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(num_filters[0])
        self.relu = nn.ReLU(inplace=True)
...
def resnet20_test(**kwargs):
    return ResNet_test(20, [16, 16, 32, 64], "basicblock", **kwargs)

def resnet32(**kwargs):
    return ResNet(32, [16, 16, 32, 64], "basicblock", **kwargs)

def resnet32_test(**kwargs):
    return ResNet_test(32, [16, 16, 32, 64], "basicblock", **kwargs)
...
def resnet56_test(**kwargs):
    return ResNet_test(56, [16, 16, 32, 64], "basicblock", **kwargs)
...
def resnet8x4_test(**kwargs):
    return ResNet_test(8, [32, 64, 128, 256], "basicblock", **kwargs)

def resnet20x4(**kwargs):
    return ResNet(20, [32, 64, 128, 256], "basicblock", **kwargs)

def resnet20x4_test(**kwargs):
    return ResNet_test(20, [32, 64, 128, 256], "basicblock", **kwargs)
