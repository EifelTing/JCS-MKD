...
# JCS_MKD CFG
CFG.JCS_MKD = CN()
CFG.JCS_MKD.IF_NORMALIZE = True
CFG.JCS_MKD.onlyCAT = False
CFG.JCS_MKD.IF_BINARIZE = False

CFG.JCS_MKD.IF_OnlyTransferPartialCAMs = False
CFG.JCS_MKD.CAMs_Nums = 100
CFG.JCS_MKD.Strategy = 0

CFG.JCS_MKD.LOSS = CN()
CFG.JCS_MKD.LOSS.CE_WEIGHT = 1.0
CFG.JCS_MKD.LOSS.CAT_loss_weight = 400.0
CFG.JCS_MKD.LOSS.CAM_RESOLUTION = 2

CFG.JCS_MKD.teacher_dir = None
CFG.JCS_MKD.student_dir = None
...
CFG.DATASET.REDUCTION=False
CFG.DATASET.RESERVED_RATE = 1.
CFG.DATASET.RESERVED_CLASS_NUM = 100
...
CFG.REVIEWKD.SHAPES = [1,4,8,16]
CFG.REVIEWKD.OUT_SHAPES = [1,8,16,32]
CFG.REVIEWKD.IN_CHANNELS = [240,480,960,960]
...
CFG.DKD = CN()
CFG.DKD.if_vanilla = True
CFG.DKD.test_weight = 200.
